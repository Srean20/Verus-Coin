# Installation:
0. Download & install latest AutoStart App Manager [AutoStartAppManager](https://apkcombo.com/id/autostart-app-manager/com.sugarapps.autostartmanager/download/apk):
